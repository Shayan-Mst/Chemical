...
const AboutUs = () => {
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-gray-900 via-blue-900 to-blue-800 text-white">
    <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
                <h3 className="text-4xl font-bold mb-6">درباره تندیس شیمی</h3>
                <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                    بر پایه‌ی اصول کیفیت، قابلیت اطمینان و خدمت‌رسانی به مشتری، تندیس شیمی به‌عنوان یک شریک قابل اعتماد در تأمین مواد شیمیایی صنعتی در سراسر کشور شناخته شده است.
                </p>
                <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                        <div className="w-12 h-12 bg-bg-third rounded-full flex items-center justify-center flex-shrink-0">
                        ...
                        <div>
                            <h4 className="text-xl font-semibold mb-2">ماموریت ما</h4>
                            <p className="text-blue-100">ساده‌سازی فرآیند تأمین مواد شیمیایی صنعتی از طریق ارائه محصولات باکیفیت، قیمت‌گذاری مناسب</p>
                        </div>
                    </div>
                    
                    <div className="flex items-start space-x-4">
                        <div className="w-12 h-12 bg-bg-third rounded-full flex items-center justify-center flex-shrink-0">
                            <i className="text-white" data-fa-i2svg=""><svg className="w-5 h-5 svg-inline--fa fa-eye" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg=""><path fill="currentColor" d="M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm144-64c0 35.3-28.7 64-64 64c-7.1 0-13.9-1.2-20.3-3.3c-5.5-1.8-11.9 1.6-11.7 7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3z"></path></svg></i>
                        </div>
                        <div>
                            <h4 className="text-xl font-semibold mb-2">چشم انداز ما</h4>
                            <p className="text-blue-100">بدیل شدن به پیشروترین بازار دیجیتال مواد شیمیایی در ایران</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                        <div className="text-center">
                            <div className="text-4xl font-bold text-bg-third mb-2">500+</div>
                            <p className="text-blue-100">مشتری</p>
                        </div>
                        <div className="text-center">
                            <div className="text-4xl font-bold text-bg-third mb-2">50+</div>
                            <p className="text-blue-100">ماده شیمیایی</p>
                        </div>
