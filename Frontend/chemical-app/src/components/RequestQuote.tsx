    ...
    <div className="container mx-auto px-6">
        ...
        <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="grid lg:grid-cols-2">
                ...
                <div className="bg-bg-secondary p-8 lg:p-12 text-white">
                    <h4 className="text-2xl font-bold mb-6">چرا به ما درخواست بدهید؟</h4>
                    <div className="space-y-6">
                        <div className="flex items-start space-x-4">
                            <div className="w-8 h-8 bg-bg-third rounded-full flex items-center justify-center flex-shrink-0 mt-1">
