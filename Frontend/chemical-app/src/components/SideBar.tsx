...
const SideBar = () => {
   ...
   const { sidebarOpen} = useUI()
    ...
    const navigate = useNavigate();
     ...
     const requestQouteHandler = () => {
      if(location.pathname === "/")document.getElementById("quote")?.scrollIntoView({ behavior: "smooth" })
 ...
 <Button variant="blue" size=''  onClick={requestQouteHandler}> 
