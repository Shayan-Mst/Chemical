            ...
            <div>
                ...
                <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                        ...
                        <span dir="ltr" className="text-gray-300">+98 21 xxxx xxxx</span>
                    </div>
                    <div className="flex items-center space-x-3">
                        ...
                        <span dir="ltr" className="text-gray-300">info@chemtrade-iran.com</span>
                    </div>
                    <div className="flex items-center space-x-3">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-300">شنبه تا پنجشنبه - ۸ تا ۵ بعد از ظهر</span>
                    </div>
                </div>
            </div>
        </div>
