...
<div className="text-sm font-semibold opacity-70"> فروش انواع مواد شیمیایی </div>
      ...
      <ul className="hidden lg:flex items-center space-x-10 text-[var(--text-secondary)] ">
        ...
        <li><Link to="/" className="font-semibold  hover:text-[var(--bg-secondary)]  transition-colors duration-200">کیفیت</Link></li>
        <li><Link to="/" className="font-semibold  hover:text-[var(--bg-secondary)]  transition-colors duration-200">درباره ما</Link></li>
         <li><Link to="/" className="font-semibold  hover:text-[var(--bg-secondary)]  transition-colors duration-200">تماس با ما</Link></li>
      </ul>
