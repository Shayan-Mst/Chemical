  ...
  return (
                    ...
                    <div className="bg-white rounded-xl shadow-sm hover:shadow-xl transition-shadow duration-300 overflow-hidden group">
                        ...
                        <div className="p-6">
                          ...
                          item.includes("خلوص")? <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded text-xs">{item}</span>:
                          <span className="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs">{item}</span>
                                ))}
